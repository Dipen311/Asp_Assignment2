using DipensBooks.DataAccess.Repository;
using DipensBooks.DataAccess.Repository.IRepository;
using DipensBooks.Models;
using DipensBookStore.Models;
using DipensBookStore.Models.ViewModels;
...
namespace DipensBookStore.Area.Customer.Controllers
{
    [Area("Customer")]
